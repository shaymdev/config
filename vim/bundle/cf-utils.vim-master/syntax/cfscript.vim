...
syn region  cfComment       start="/\*" end="\*/" fold contains=cfCommentTodo,cfJavaDoc
...
" CF Function region for folding....****SHAY****
" syn region cfFunction		start="{" end=/}/ transparent fold keepend extend
" syn sync fromstart
" set foldnestmax=1
